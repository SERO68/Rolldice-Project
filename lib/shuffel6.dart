...
class Shuffel6 extends StatefulWidget {
  const Shuffel6({super.key});

  @override
  State<Shuffel6> createState() => _ShuffelState();
}

class _ShuffelState extends State<Shuffel6> {
  var activedice1 = 1;
  var activedice2 = 1;
  var activedice3 = 1;
  var activedice4 = 1;
  ...
  void clickedimage6() {
    setState(() {
      if (imagechange6 == false) {
        name6 = 'block';
        imagechange6 = !imagechange6;
      } else {
        name4 = 'dice';
        imagechange6 = !imagechange6;
      }
  ...
  void rolldice() {
    setState(() {
      ...
      if (imagechange6 == false) {
        activedice6 = random.nextInt(6) + 1;
      }
      sum = activedice1 +
          activedice2 +
          activedice3 +
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: clickedimage6,
                        child: Image(
                          image: AssetImage('images/$name6-$activedice6.png'),
                          width: 130,
                        ),
                      ),
                    ],
